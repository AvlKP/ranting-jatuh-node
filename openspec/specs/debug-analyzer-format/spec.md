# debug-analyzer-format Specification

## Purpose
Define the Python-side analysis script's parsing, recomputation, JSON output, and plotting behavior for firmware debug dumps containing centerline modal analysis data.
