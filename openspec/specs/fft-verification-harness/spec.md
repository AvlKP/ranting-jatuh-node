# fft-verification-harness Specification

## Purpose
Standalone ESP-IDF project for verifying the FFT-based natural frequency pipeline against a known physical oscillation on the same ESP32-S3FH4R2 PCB.
