/// @file network_on_demand.cpp
/// @brief On-demand WiFi strategy for field deployment.
/// @details Performs full WiFi connect/disconnect cycle per publish.
/// WiFi is started, connected, IP acquired, used, then disconnected and stopped
/// to conserve power between publish cycles.
/// @ingroup logger
